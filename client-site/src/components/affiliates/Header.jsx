...
const Header = ({ heroRef, introductionRef, productsRef, affiliateRef }) => {
            ...
            <header className="bg-backgroundImageRed text-white shadow-md py-30 pl-4 lg:pl-0 w-full z-10">
                <div className="container mx-auto  flex justify-around lg:justify-between lg:px-28">
                    ...
                    {isMenuOpen && (
                        <ul
                        ref={menuRef}
                        className="menu bg-green-800 w-56 h-full absolute top-16 left-0 z-50">
                            <li>
                                <Link to="/login">
                    ...
                    <div className="w-24 lg:w-36 sans-serif">
                        <img src="http://darazplaypartner.com/wp-content/uploads/2024/07/footer_logo.png" alt="" />
                    </div>
                    ...
                    >
                        <div className="bg-green-600 rounded-t-lg p-4">
                            <div className="flex justify-center items-center">
                                <h3 className="text-lg text-black font-semibold">Select Currency and Language</h3>
                                <button
                        ...
                        <div className="bg-white rounded-b-lg p-4">
                            <div className="grid grid-cols-3 items-center gap-x-6 mb-5 py-2 px-0">
                                ...
                                <div className='py-0 px-3'>
                                    <button type="submit" className="bg-white py-1 px-5 text-customBlack font-semibold hover:bg-white hover:border-yellow-400 shadow-customShadow border-white">
                                        Bengali
                                    </button>
                                </div>
                                <div className='py-0 px-3'>
