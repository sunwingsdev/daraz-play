        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="card bg-white w-full max-w-sm shrink-0 shadow-2xl">
            ...
            <div className="form-control">
                <h3 className="text-left font-medium text-2xl text-black">Sign In</h3>
              </div> 
              ...
              <div className="form-control">
                ...
                <label className="label">
                  <span className="label-text text-black border-black font-medium ">Username</span>
                </label>
              ...
              <div className="form-control">
                <label className="label-text text-black border-black">
                  <span className="label-text text-black border-black font-medium">Password</span>
                </label>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-black border-black font-medium">Select Language</span>
                </label>
